...
0x99A8f545234c150A0d13eef668c77835eCbbc15F

## Public Deployment

The application is publically avaialable at the following url:

https://61a6f99b862bea0007e93b63--focused-poincare-435243.netlify.app/
...
## Solidity Contract Construction

This project employs a ticket factory / minter construction where each new ticket offering (represented by the "GAEventTickets" contract) is generated by the "EventTicketingFactory" contract.

The "EventTicketingFactory" contract also maintains an array of addresses of all "GAEventTickets" instances deployed.

The "GAEventTickets" contract follows / inherits the ERC20 standard and includes additional functionality.

The code for both these contracts is located in the "EventTicketingFactory.sol" file in the "src/contracts" directory:

https://github.com/cordero67/blockchain-developer-bootcamp-final-project/blob/main/src/contracts/EventTicketingFactory.sol

The "EventTicketingFactory" contract has been deployed to the Rinkeby network at the following address:

0xd817009dF60F96DD330289cd15BcF89d0DA68d15
...
Inside a terminal window navigate to the project's root directory and type "npm install". This will install all the packages and their dependencies identified in the "package.json" file into the project's node_modules folder.
...
- In a terminal window navigate to the project's root directory and type “truffle test”
...
-     Comment out line 20 and uncomment line 21 in the truffle-config.js file.

-     In a terminal window, type “ganache-cli”

-     In a separate terminal window navigate to the project's root directory and type “truffle test”
